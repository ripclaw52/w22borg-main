...
public class CalendarUtils
{
    ...
    public static ShiftModel findShiftModelFromDateAndType(List<ShiftModel> shiftModels, LocalDate date, int type) {
        for (ShiftModel shiftModel : shiftModels) {
            if (shiftModel.getShiftType() == type) {
                if (shiftModel.getLocalDate().equals(date)) {
                    return new ShiftModel(shiftModel);
                }
            }
        }
        return null;
